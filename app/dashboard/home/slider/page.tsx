    ...
    <main className="min-h-[calc(100vh-5.2rem)] px-10 py-5">
      ...
      <div className="mb-10 ml-2 font-sans">
         <h1 className="xl:text-xl font-bold">
          <TranslateText
            english_text="Add Slider Content"
            marathi_text="स्लाइडर सामग्री जोडा">
            Add Slider Content
          </TranslateText>
        </h1>
          ...
          className="text-sm mt-2 text-muted-foreground"
            english_text="Fill in the details to add slider content."
            marathi_text="स्लाइडर सामग्री जोडण्यासाठी तपशील भरा.">
            Fill in the details to add slider content.
          </TranslateText>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 max-w-2xl">
        ...
        <div>
          <Label htmlFor="m_title" className="mt-5">Marathi Title</Label>
          <Input
            id="m_title"
            type="text"
