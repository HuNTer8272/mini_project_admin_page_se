    ...
    <main className="min-h-[calc(100vh-5.2rem)] px-10 py-5">
      ...
      <div className="mb-10 ml-2 font-sans">
        <h1 className="xl:text-xl font-bold">
          <TranslateText
            english_text="Create Event"
            marathi_text="कार्यक्रम तयार करा">
            {" "}
            Create Event
          </TranslateText>
        </h1>
          ...
          className="text-sm mt-2 text-muted-foreground"
            english_text="Fill in the details to create a new event."
            marathi_text="नवीन कार्यक्रम तयार करण्यासाठी तपशील भरा.">
