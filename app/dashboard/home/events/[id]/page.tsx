...
const EditSliderPage = () => {
  ...
  useEffect(() => {
    const fetchSlider = async () => {
      try {
        const res = await fetch(`/api/home-events?id=${id}`);
    ...
    <main className="min-h-[calc(100vh-5.2rem)] px-10 py-5">
      ...
      <div className="mb-10 ml-2 font-sans">
        <h1 className="xl:text-xl font-bold">
          <TranslateText
            english_text="Edit Events"
            marathi_text="इव्हेंट संपादित करा">
            {" "}
            Edit Events
          </TranslateText>
        </h1>
          ...
          className="text-sm mt-2 text-muted-foreground"
            english_text="Update the slider details."
            marathi_text="इव्हेंट तपशील अद्यतनित करा.">
