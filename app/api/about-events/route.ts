    ...
    try {
        ...
        if (id) {
        const event = await prisma.about_events.findUnique({
            where: { id: Number(id) },
        });
        if (!event)
        ...
        const about_events = await prisma.about_events.findMany();
        const decompressedevents = about_events.map((event) => ({
            ...event,
    ...
    try {
        ...
        const event = await prisma.about_events.create({
        data: {
    ...
    try {
        ...
        const event = await prisma.about_events.delete({
    ...
    export async function PUT(request: Request) {
        ...
        const event = await prisma.about_events.update({
            where: { id: Number(data.id) },
            data: {
